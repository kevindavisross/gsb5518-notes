...
\
\
1.  The Dodgers are how many times more likely than the Phillies to win?
\
\
\
\
\
1.  What must be the probability that the Dodgers do *not* win the championship?
...
\
\
1.  How could you construct a circular spinner (like from a kids game) to simulate the World Series champion according to these probabilities? 
...
2.  Randomly select a man.
    ...
    b.  The probability that a randomly selected man is greater than six feet tall.
    c.  The probability that a randomly selected man who plays in the NBA is greater than six feet tall.
...
6.  In the [Powerball lottery](https://www.powerball.com/) there are roughly 300 million possible winning number combinations, all equally likely.
